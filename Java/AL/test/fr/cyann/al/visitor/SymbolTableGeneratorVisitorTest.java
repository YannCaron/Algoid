 ...
 * @author CyaNn
 */
public class SymbolTableGeneratorVisitorTest extends TestCase {
    ...
    static {
	visitor = new SymbolTableGeneratorVisitor();
    }
     ...
     */
    public SymbolTableGeneratorVisitorTest(Class<? extends AST> cls) {
	...
	for (String className : Reflect.getClassNamesFromPackage(PACKAGE)) {
		...
		suite.addTest(new SymbolTableGeneratorVisitorTest(cls));
	    }
	}
