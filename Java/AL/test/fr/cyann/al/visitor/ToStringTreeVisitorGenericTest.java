 ...
 * @author CyaNn
 */
public class ToStringTreeVisitorGenericTest extends TestCase {
    ...
    static {
	visitor = new ToStringTreeVisitor();
    }
     ...
     */
    public ToStringTreeVisitorGenericTest(Class<? extends AST> cls) {
	...
	for (String className : Reflect.getClassNamesFromPackage(PACKAGE)) {
		...
		suite.addTest(new ToStringTreeVisitorGenericTest(cls));
	    }
	}
